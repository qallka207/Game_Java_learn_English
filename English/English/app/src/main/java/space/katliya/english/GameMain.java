...
public class GameMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(GameMain.this, Level1.class);
                    startActivity(intent); finish();
                }catch (Exception e){
        ...
        level2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(GameMain.this, Level2.class);
                    startActivity(intent); finish();
                }catch (Exception e){
        ...
        level3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(GameMain.this, Level3.class);
                    startActivity(intent); finish();
                }catch (Exception e){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(GameMain.this, Main2.class);
                    startActivity(intent); finish();
                }catch (Exception e){
