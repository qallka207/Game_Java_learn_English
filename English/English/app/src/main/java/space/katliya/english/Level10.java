    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level10.this, GameMain4.class);
        ...
        final String[] answer = new String[]{"red", "orange", "green", "pink", "yellow",};

        //1 уровень
        final int[] aq = new int[5];

        answer1 = answer[j];
        img1.setImageResource(array.image10[i]);
        text_1.setText(array.text10[i]);
        img2.setImageResource(array.image10[i + 1]);
        text_2.setText(array.text10[i + 1]);
        img3.setImageResource(array.image10[i + 2]);
        text_3.setText(array.text10[i + 2]);
        img4.setImageResource(array.image10[i + 3]);
        text_4.setText(array.text10[i + 3]);
        vopros.setText(array.vopros10[j]);
        // 1 картинка
