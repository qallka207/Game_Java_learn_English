    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level11.this, GameMain4.class);
       ...
       Button button_back = (Button) findViewById(R.id.button_back);
        ...
        img1.setImageResource(array.image11[i]);
        text_1.setText(array.bukva111[i]);
        text_3.setText(array.bukva113[i]);
        final String[] answer = new String[]{"e", "a", "r", "i", "e",};
