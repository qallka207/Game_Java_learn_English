    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level12.this, GameMain4.class);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    backToast = Toast.makeText(getBaseContext(), "Конец", Toast.LENGTH_SHORT);
                    backToast.show();
                } catch (Exception e) {
        ...
        text1.setText(array.vopros12[0]);
        text2.setText(array.vopros12[1]);
        text3.setText(array.vopros12[2]);
        text4.setText(array.vopros12[3]);
        text5.setText(array.vopros12[4]);
        ...
        final boolean[] ok = new boolean[] {false, false, true, false, false};
