    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level5.this, GameMain2.class);
       ...
       Button button_back = (Button) findViewById(R.id.button_back);
        ...
        img1.setImageResource(array.image5[i]);
        text_1.setText(array.bukva51[i]);
        text_3.setText(array.bukva53[i]);
        final String[] answer = new String[]{"o", "a", "o", "w", "b",};
