    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level6.this, GameMain2.class);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level6.this, Main3.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
        ...
        text1.setText(array.vopros6[0]);
        text2.setText(array.vopros6[1]);
        text3.setText(array.vopros6[2]);
        text4.setText(array.vopros6[3]);
        text5.setText(array.vopros6[4]);
        ...
        final boolean[] ok = new boolean[] {true, false, false, true, true};
