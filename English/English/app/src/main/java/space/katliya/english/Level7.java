    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level7.this, GameMain3.class);
        ...
        final String[] answer = new String[]{"apple", "banana", "donut", "orange", "pineapple",};

        //1 уровень
        final int[] aq = new int[5];

        answer1 = answer[j];
        img1.setImageResource(array.image7[i]);
        text_1.setText(array.text7[i]);
        img2.setImageResource(array.image7[i + 1]);
        text_2.setText(array.text7[i + 1]);
        img3.setImageResource(array.image7[i + 2]);
        text_3.setText(array.text7[i + 2]);
        img4.setImageResource(array.image7[i + 3]);
        text_4.setText(array.text7[i + 3]);
        vopros.setText(array.vopros7[j]);
        // 1 картинка
