    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level8.this, GameMain3.class);
       ...
       Button button_back = (Button) findViewById(R.id.button_back);
        ...
        img1.setImageResource(array.image8[i]);
        text_1.setText(array.bukva81[i]);
        text_3.setText(array.bukva83[i]);
        final String[] answer = new String[]{"p", "a", "o", "g", "a",};
