    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level9.this, GameMain3.class);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level9.this, Main4.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {
        ...
        text1.setText(array.vopros93[0]);
        text2.setText(array.vopros93[1]);
        text3.setText(array.vopros93[2]);
        text4.setText(array.vopros93[3]);
        text5.setText(array.vopros93[4]);
        ...
        final boolean[] ok = new boolean[] {false, false, true, false, true};
